...
export default function InvestingSection() {
  return (
    <section className="relative bg-[#67D99D] mt-20 py-12 h-[360px] sm:h-[355px] overflow-hidden">
      ...
      <div className="relative z-10 flex justify-center items-center h-full">
        <div className="px-4">
          ...
          <p className="max-w-md font-semibold text-center text-[17px] sm:text-[21px] leading-6 sm:leading-8 sm:text-lg">
