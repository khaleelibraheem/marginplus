...
export default function FundingSection() {
  return (
    <section className="md:px-30 xl:px-45 mt-36 flex flex-col-reverse items-center lg:justify-between lg:flex-row gap-8 lg:items-baseline-last max-w-[1400px] mx-auto">
